import { AlertTriangle, Bell, Calendar, CheckCircle, MessageSquare } from "lucide-react"
          ...
          <li className="border-b last:border-0">
            <button className="flex w-full items-start gap-4 p-4 text-left hover:bg-muted/50">
              ...
              <div className="grid gap-1">
                ...
                <div className="text-xs text-muted-foreground">John sent you a message about the project</div>
          ...
          <li className="border-b last:border-0">
            <button className="flex w-full items-start gap-4 p-4 text-left hover:bg-muted/50">
              ...
              <div className="grid gap-1">
                ...
                <div className="text-xs text-muted-foreground">Your storage is almost full (85%)</div>
          ...
          <li className="border-b last:border-0">
            <button className="flex w-full items-start gap-4 p-4 text-left hover:bg-muted/50">
              ...
              <div className="grid gap-1">
                ...
                <div className="text-xs text-muted-foreground">Project milestone has been achieved</div>
          ...
          <li className="border-b last:border-0">
            <button className="flex w-full items-start gap-4 p-4 text-left hover:bg-muted/50">
              ...
              <div className="grid gap-1">
                ...
                <div className="text-xs text-muted-foreground">Team standup at 10:00 AM tomorrow</div>
